...
// (MIT; see server/src/context/vendor/fast-jev-compaction/LICENSE): upstream's own suite, run by
// bun:test instead of vitest. Changed: the two import lines. Nothing else.
